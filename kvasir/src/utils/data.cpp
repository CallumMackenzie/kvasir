...
const char *objects3d::get_cube_obj()
{
...
const char *diffuse3d::get_fragment()
{
...
const char *diffuse2d::get_vertex()
{
...
const char *diffuse2d::get_fragment()
{
